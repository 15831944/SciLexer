...
public:
	...
	int SearchStringLight; //°ó¶¨
	int SearchStringLightValue; //°ó¶¨
	std::string CurSearchString; //°ó¶¨
	void NotifyLexerChanged(Document*, void*);
	void SetRedraw();
	void FoldLineNotUpdate(Sci::Line line, FoldAction action);
